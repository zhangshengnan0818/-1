...
(function () {
  ...
  MobileSelect.prototype = {
    constructor: MobileSelect, init: function (config) {
      ...
      _this.mobileSelect.innerHTML = '<div class="grayLayer"></div>' + '<div class="content">' + '<div class="btnBar">' + '<div class="fixWidth">' + '<div class="cancel">' + cancelText + "</div>" + '<div class="title"></div>' + '<div class="ensure">' + ensureText + "</div>" + "</div>" + "</div>" + '<div class="panel">' + '<div class="fixWidth">' + '<div class="wheels">' + "</div>" + '<div class="selectLine"><div class="ld">:</div><div class="hx">—</div><div class="rd">:</div></div>' + '<div class="shadowMask"></div>' + "</div>" + "</div>" + "</div>";
